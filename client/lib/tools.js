...
export const TOOL_CATEGORIES = [
  {
    ...
    tools: [
      { id: 'merge', label: 'Merge PDF', desc: 'Combine PDFs with custom order & metadata', icon: <Combine size={24} />, endpoint: '/api/pdf/merge', multi: true, accept: { 'application/pdf': ['.pdf'] } },
      { id: 'split', label: 'Split PDF', desc: 'Split by ranges or into single pages', icon: <Scissors size={24} />, endpoint: '/api/pdf/split', accept: { 'application/pdf': ['.pdf'] } },
      { id: 'remove-pages', label: 'Remove Pages', desc: 'Delete specific pages from a PDF', icon: <FileX size={24} />, endpoint: '/api/pdf/remove-pages', accept: { 'application/pdf': ['.pdf'] } },
      { id: 'extract-pages', label: 'Extract Pages', desc: 'Extract page ranges into a new PDF', icon: <FileUp size={24} />, endpoint: '/api/pdf/extract-pages', accept: { 'application/pdf': ['.pdf'] } },
      { id: 'organize', label: 'Organize PDF', desc: 'Reorder pages by custom sequence', icon: <ListOrdered size={24} />, endpoint: '/api/pdf/organize', accept: { 'application/pdf': ['.pdf'] } },
    ],
  },
  {
    id: 'optimize',
  ...
  },
  {
    ...
    tools: [
      { id: 'word-to-pdf', label: 'Word to PDF', desc: 'Convert .docx/.doc to PDF', icon: <FileText size={24} />, endpoint: '/api/convert/word-to-pdf', accept: { 'application/msword': ['.doc'], 'application/vnd.openxmlformats-officedocument.wordprocessingml.document': ['.docx'] } },
      { id: 'jpg-to-pdf', label: 'JPG to PDF', desc: 'Convert JPG/JPEG images to PDF', icon: <ImageIcon size={24} />, endpoint: '/api/convert/jpg-to-pdf', multi: true, accept: { 'image/jpeg': ['.jpg', '.jpeg'] } },
      { id: 'png-to-pdf', label: 'PNG to PDF', desc: 'Convert PNG images to PDF', icon: <ImageDown size={24} />, endpoint: '/api/convert/png-to-pdf', multi: true, accept: { 'image/png': ['.png'] } },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'pdf-to-html', label: 'PDF to HTML', desc: 'Convert PDF document to formatted web HTML', icon: <FileCode size={24} />, endpoint: '/api/convert/pdf-to-html', accept: { 'application/pdf': ['.pdf'] } },
    ],
  },
  {
    id: 'convert-word',
  ...
  },
  {
    ...
    tools: [
      { id: 'jpg-to-png', label: 'JPG to PNG', desc: 'Convert JPG/JPEG images to PNG with transparency', icon: <ImageIcon size={24} />, endpoint: '/api/convert/jpg-to-png', accept: { 'image/jpeg': ['.jpg', '.jpeg'] } },
      { id: 'png-to-jpg', label: 'PNG to JPG', desc: 'Convert PNG to high-quality JPG image', icon: <ImageDown size={24} />, endpoint: '/api/convert/png-to-jpg', accept: { 'image/png': ['.png'] } },
      { id: 'image-to-webp', label: 'Image to WebP', desc: 'Convert images to high-compression WebP format', icon: <Layers size={24} />, endpoint: '/api/convert/image-to-webp', accept: { 'image/*': ['.jpg', '.jpeg', '.png', '.bmp', '.tiff'] } },
      { id: 'webp-to-jpg', label: 'WebP to JPG', desc: 'Convert WebP images to standard JPG format', icon: <ImageIcon size={24} />, endpoint: '/api/convert/webp-to-jpg', accept: { 'image/webp': ['.webp'] } },
      { id: 'webp-to-png', label: 'WebP to PNG', desc: 'Convert WebP images to lossless PNG format', icon: <ImageDown size={24} />, endpoint: '/api/convert/webp-to-png', accept: { 'image/webp': ['.webp'] } },
      { id: 'image-to-text', label: 'Image to Text (OCR)', desc: 'Extract recognized text from photos and scans', icon: <Wand2 size={24} />, endpoint: '/api/convert/image-to-text', accept: { 'image/*': ['.jpg', '.jpeg', '.png', '.webp', '.bmp', '.tiff'] } },
    ],
  },
  {
    id: 'edit',
    ...
    tools: [
      { id: 'sign-pdf', label: 'Sign PDF', desc: 'Sign every page — typed or image signature', icon: <PenTool size={24} />, endpoint: '/api/pdf/sign', accept: { 'application/pdf': ['.pdf'] }, hasSignatureUpload: true, showsPageCount: true },
      { id: 'add-text', label: 'Type on PDF', desc: 'Multi-line text on all or selected pages', icon: <Type size={24} />, endpoint: '/api/pdf/add-text', accept: { 'application/pdf': ['.pdf'] }, showsPageCount: true },
      { id: 'highlight', label: 'Highlight PDF', desc: 'Highlight regions on all or selected pages', icon: <Highlighter size={24} />, endpoint: '/api/pdf/highlight', accept: { 'application/pdf': ['.pdf'] }, showsPageCount: true },
      { id: 'rotate', label: 'Rotate PDF', desc: 'Rotate all or specific pages', icon: <RotateCw size={24} />, endpoint: '/api/pdf/rotate', accept: { 'application/pdf': ['.pdf'] } },
      { id: 'watermark', label: 'Add Watermark', desc: 'Diagonal or tiled watermark on all pages', icon: <Droplet size={24} />, endpoint: '/api/pdf/watermark', accept: { 'application/pdf': ['.pdf'] } },
      { id: 'page-numbers', label: 'Page Numbers', desc: 'Custom formats: Page X of Y', icon: <Hash size={24} />, endpoint: '/api/pdf/page-numbers', accept: { 'application/pdf': ['.pdf'] } },
    ],
  },
  {
    id: 'security',
